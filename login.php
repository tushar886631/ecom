...
<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(4.jpg) no-repeat scroll center center / cover ;">
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" onkeypress="myFunction()" name="email" id="email" placeholder="Your Email*" style="width:45%">
									...
									<div class="contact-btn">
										<button type="button" id="register"class="fv-btn" onclick="user_register()">Register</button>
									</div>
								</form>
	...
	function myFunction() {
		jQuery('#email_error').html('Please Verify your Eamil first');
